...
public class OrderStatusSQLQueries {
     ...
     */
	public static final String INSERT_STATUS = "INSERT INTO order_status (status_name) VALUES (?)";
	
	/**
     * SQL query to retrieve an order status by its ID from the database.
     */
	public static final String GET_STATUS_BY_ID = "SELECT * FROM order_status WHERE id = ?";
     ...
     */
	public static final String UPDATE_STATUS = "UPDATE order_status SET status_name = ? WHERE id = ?";
	
	/**
     * SQL query to delete an order status from the database by its ID.
     */
	public static final String DELETE_STATUS = "DELETE FROM order_status WHERE id = ?";
